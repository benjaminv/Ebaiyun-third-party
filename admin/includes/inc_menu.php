...
//@author guan 菜单管理（商品仓库） start
//$modules['02_cat_and_goods']['goods_warehouse']        = 'goods_warehouse.php?act=list';
//@author guan 菜单管理（商品仓库） end

/* $modules['03_promotion']['02_snatch_list'] = 'snatch.php?act=list'; */

//$modules['03_promotion']['04_bonustype_list'] = 'bonus.php?act=list'; //by 红包类型 zxiaoy 注释
...
//$modules['03_promotion']['09_topic'] = 'topic.php?act=list'; //by 专题管理 zxiaoy 注释

//$modules['03_promotion']['10_auction'] = 'auction.php?act=list'; //by 拍卖活动 zxiaoy 注释
//$modules['03_promotion']['12_favourable'] = 'favourable.php?act=list';//by 优惠活动 zxiaoy 注释
// $modules['03_promotion']['13_wholesale'] = 'wholesale.php?act=list';// by 超值礼包
...
// 抽奖end
//$modules['03_promotion']['25_pre_sale_list'] = 'pre_sale.php?act=list'; //by 预售 zxiaoy 注释
//$modules['03_promotion']['26_cut']       = 'cut.php?act=list';//by 砍价活动 zxiaoy 注释
$modules['03_promotion']['28_extpintuan']       = 'extpintuan.php?act=list';//新版拼团
$modules['03_promotion']['30_lucky_buy']       = 'lucky_buy.php?act=list';// by 云购 zxiaoy 注释
...
$modules['08_members']['17_affiliate'] = 'affiliate.php?act=list';
$modules['08_members']['18_affiliate_ck'] = 'affiliate_ck.php?act=list';
...
$modules['12_template']['02_template_select'] = 'template.php?act=list'; //by 模版选择 zxiaoy 注释
$modules['12_template']['03_template_setup'] = 'template.php?act=setup'; //by 设置模板 zxiaoy 注释
$modules['12_template']['04_template_library'] = 'template.php?act=library';//by 库项目管理 zxiaoy 注释
// $modules['12_template']['05_edit_languages'] = 'edit_languages.php?act=list';//by 语言项编辑 zxiaoy 注释
...
/* 代码增加_start By www.68ecshop.com */
//$modules['03_promotion']['16_takegoods_list'] = 'takegoods.php?act=list';//by 提货券管理 zxiaoy 注释
//$modules['03_promotion']['16_takegoods_order'] = 'takegoods.php?act=order_list';// by 提货券提货列表 zxiaoy 注释
/* 代码增加_end By www.68ecshop.com */
...
/* 代码增加_start By www.68ecshop.com */
//$modules['03_promotion']['19_valuecard_list'] = 'valuecard.php?act=list'; //by 储值卡管理 zxiaoy 注释
