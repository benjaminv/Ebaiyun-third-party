 ...
 * XanyShop 订单管理
 * ============================================================================
 * 版权所有 2014-2017 山东云拓电子商务有限公司，并保留所有权利。
 * ----------------------------------------------------------------------------
...
elseif ($_REQUEST['act'] == 'delivery_ship')
{
   ...
   //          include_once('../send.php');
            ...
            sendSMS($order['mobile'], $params, $moban);  
        }
    }
...
function order_list()
{
    ...
    if ($result === false)
    {
        ...
        if($_REQUEST['act'] == 'invoice_list' || (isset($_REQUEST['act_detail'])&&$_REQUEST['act_detail']=='invoice_query'))
        {
         ...
         /* 普通订单不显示虚拟团购订单 添加_START_www.xany6.com*/
        $where .= " AND o.extension_code != 'virtual_good'";
         /* 普通订单不显示虚拟团购订单 添加_END_www.xany6.com*/
		/*增值税发票_添加_END_www.xany6.com*/
        //综合状态
        switch($filter['composite_status'])
        {
