      ...
      <div class="gList_r">
        ...
        <div class="gRate">
          <div class="Progress-bar">
            ...
            <ul class="Pro-bar-li">
              <li class="P-bar01">当前进程<em>'. $chicun.'%</em></li>
              <li class="P-bar03">还有<em>'. $last_lucky_buy['available'].'</em>人次</li>
            </ul>
          </div>
          <div class="text">
        <em>￥'. $vo['oneprice'] . '</em>
          <a class="" href="' . $vo['url'] . '">立即抽奖</a> 
</div>
          </div>
      </div>
    </li>'
...
<div class="lb_status" >第' . $vo['schedule_id'] . '期&nbsp;&nbsp;' . $status . '</div>   
		  ...
		  <div class="lb_actions" ><a href="' . $vo['url'] . '">抽奖详情</a></div>	'
            );
        }
    }
   //  print_r( $goodslist  );
