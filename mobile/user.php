...
if($_REQUEST['app_act']=='ajax'){
	$user_id = $_SESSION['user_id'];
	$order_id = $_COOKIE['order_id'];
	/* 订单详情 */
	include_once (ROOT_PATH . 'includes/lib_pay.php');
...
$smarty->assign('web_app',$_COOKIE['web_app']);
$back_act = '';
...
//	}
	...
	if($_COOKIE['web_app']){
		setcookie('order_id',$order['order_id']);
	}
