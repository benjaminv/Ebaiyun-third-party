...
/* 当前页面标题及可用链接名称 */
$_LANG['lucky_buy_list'] = '抽奖活动列表'; //云购
$_LANG['add_lucky_buy'] = '添加抽奖活动'; //云购
$_LANG['edit_lucky_buy'] = '编辑抽奖活动'; //云购
...
$_LANG['error_lucky_buy'] = '您要操作的抽奖活动不存在';
...
$_LANG['cancel_order_reason'] = '抽奖失败';
$_LANG['js_languages']['succeed_confirm'] = '此操作不可逆，您确定要设置该抽奖活动成功吗？';
$_LANG['js_languages']['fail_confirm'] = '此操作不可逆，您确定要设置该抽奖活动失败吗？';
$_LANG['button_mail'] = '发送邮件';
$_LANG['notice_mail'] = '（通知客户付清余款，以便发货）';
$_LANG['mail_result'] = '该抽奖活动共有 %s 个有效订单，成功发送了 %s 封邮件。';
$_LANG['invalid_time'] = '您输入了一个无效的抽奖时间。';

$_LANG['add_success'] = '添加抽奖活动成功。';
$_LANG['edit_success'] = '编辑抽奖活动成功。';
$_LANG['back_list'] = '返回抽奖活动列表。';
$_LANG['continue_add'] = '继续添加抽奖活动。';

/* 添加/编辑活动提交 */
$_LANG['error_goods_null'] = '您没有选择抽奖商品！';
$_LANG['error_goods_exist'] = '您选择的商品目前有一个抽奖活动正在进行！';
$_LANG['error_price_ladder'] = '您没有输入有效的价格阶梯！';
$_LANG['error_restrict_amount'] = '限购数量不能小于价格阶梯中的最大数量';

$_LANG['js_languages']['error_goods_null'] = '您没有选择抽奖商品！';
...
/* 删除云购活动 */
$_LANG['js_languages']['batch_drop_confirm'] = '您确定要删除选定的抽奖活动吗？';
$_LANG['error_exist_order'] = '该抽奖活动已经有订单，不能删除！';
$_LANG['batch_drop_success'] = '成功删除了 %s 条抽奖活动记录（已经有订单的抽奖活动不能删除）。';
$_LANG['no_select_lucky_buy'] = '您现在没有抽奖活动记录！';

/* 操作日志 */
$_LANG['log_action']['lucky_buy'] = '抽奖商品';
