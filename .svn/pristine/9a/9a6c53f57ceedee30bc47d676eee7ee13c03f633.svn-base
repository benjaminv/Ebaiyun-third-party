...
{   
    ...
    $smarty->assign('action_link2',  array('href' => 'lucky_buy.php?act=view', 'text' => '查看所有抽奖概览'));
...
elseif ($_REQUEST['act'] == 'view')
{
    ...
    if($act_id && $lucky_buy_id){
		...
		$smarty->assign('action_link',  array('text' => '抽奖概览', 'href'=>'lucky_buy.php?act=view&act_id='.$act_id));
		...
		$smarty->assign('full_page',    1);
		$smarty->assign('ur_here',      '活动详情' );
		$smarty->assign('action_link',  array('text' => '抽奖活动列表', 'href'=>'lucky_buy.php?act=list'));
