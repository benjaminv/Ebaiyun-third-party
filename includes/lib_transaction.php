...
{
    /* 查询订单信息，检查状态 */
    $sql = "SELECT user_id, order_sn , order_status, shipping_status, pay_status,goods_amount,supplier_id FROM ".$GLOBALS['ecs']->table('order_info') ." WHERE order_id = '$order_id'";
    ...
    else
    {
        ...
        if ($GLOBALS['db']->query($sql))
        {
            ...
            //调取供货商系统
            $url = "http://ebysys.ebaiyunmall.com/index.php?s=/Home/Test/shopping/id/".$order['user_id']."/gdmt/".$order['goods_amount']."/gid/".$order['supplier_id']."";
